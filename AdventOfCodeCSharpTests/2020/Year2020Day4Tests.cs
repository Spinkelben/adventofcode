...
{
    public class Year2020Day4Tests
    {
        [Theory]
        [MemberData(nameof(TestData))]
        public void Part1(List<string> passports, int numberOfValidPassports)
        {
            var puzzleSolver = new Year2020Day4();
            Assert.Equal(numberOfValidPassports.ToString(), puzzleSolver.Part1(passports));
        }
